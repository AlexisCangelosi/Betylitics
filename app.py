...
with st.sidebar:
        ...
        if st.session_state.matches and isinstance(st.session_state.matches, list) and len(st.session_state.matches) > 0:
            ...
            for m in sorted_matches:
                ...
                display_str = (
                    ...
                    f"{m.get('Domicile', 'N/A')} 🆚 {m.get('Extérieur', 'N/A')} (🕒 {m.get('Heure','N/A')})"
                )
    ...
    last_updated_str = "2025-03-23 22:09"  # Replace this with your actual update time
    ...
    st.caption(f"⚙️ v1.0.0-20250323.885a - {update_message}")
